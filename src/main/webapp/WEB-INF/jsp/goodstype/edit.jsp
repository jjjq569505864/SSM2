	...
	var verifyGtname = function() {
        $.ajax({
            ...
            success: function(data){
                if (data=="SUCCESS" && $("#gtname").val()!= '${gt1.gtname}'){
		...
		<div class="span12">
			<form class="form-horizontal"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="hidden" value="${gt1.gtid }" name="gtid"/>
						<input id="gtname" value="${gt1.gtname}" type="text" name="gtname" maxlength="20" onblur="verifyGtname();" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="gtstate">菜品类型状态</label>
					<div class="controls">
						<select id="gtstate" name="gtstate">
						  <c:choose>
						    <c:when test="${gt1.gtstate==0 }">
				...
				<div class="control-group">
					<div class="controls">
						<input type="submit" class="btn" value="提交"
							id="sumb" onclick="return checkform();" />
