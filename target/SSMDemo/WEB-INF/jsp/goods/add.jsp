	...
	<div class="row-fluid">
		<div class="span12">
			<form class="form-horizontal form-inline"
				action="${pageContext.request.contextPath}/web/goods/add" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="gname" type="text" name="gname" placeholder="请输入中文或英文" onblur="verifyGname();"/>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-group">
							<input type="number" step="0.01" class="form-control"
								name="gprice" id="gprice" placeholder="￥0.00">
						</div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="form-control" name="gcontent" rows="5"
							style="width: 283px; resize: none"></textarea>
					</div>
				</div>
				<div class="control-group">
			...
			小数点后两位）">分钟
				...
				<div class="control-group">
					<div class="controls">
						<input type="submit" id="sumb" class="btn" value="提交" onclick="return checkform();"/>
