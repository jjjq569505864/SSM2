	...
	<div class="row-fluid">
		<div class="span12">
			<form class="form-horizontal"
				action="${pageContext.request.contextPath}/web/user/add"
				method="post">
				<div class="control-group">
					<label class="control-label" for="username">用户昵称:</label>
					<div class="controls">
						<input id="username" type="text" name="username" onblur="return rename()"/>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="userpwd" type="password" name="userpwd" /><span style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(密码必须由字母、数字组成，区分大小写，密码长度为8-18位)</span>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
						<input  id="submit" type="submit" class="btn" value="提交" onclick="return checkform()" />
